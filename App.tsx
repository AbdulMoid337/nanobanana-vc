...
import { Sparkles, Loader2, AlertCircle, Wand2, Plus } from 'lucide-react';
...
function App() {
  ...
  const handleGenerate = async (prompt: string) => {
    ...
    try {
      const resultBase64 = await generateMarketingAsset(sourceImage, sourceMimeType, prompt);
          ...
          <div className="lg:col-span-5 space-y-8 sticky top-28">
            ...
            <section className="space-y-4">
              ...
              <ScenarioSelector 
                ...
                disabled={!sourceImage || status === GenerationStatus.LOADING}
              />
              ...
              <form onSubmit={handleCustomGenerate} className="space-y-3">
                <div className="relative">
                    ...
                    <div className="absolute bottom-3 right-3">
                        <button
                            type="submit"
                            disabled={!sourceImage || !customPrompt.trim() || status === GenerationStatus.LOADING}
                            className={`
                                p-2 rounded-lg transition-all flex items-center gap-2 text-sm font-medium
                                ${!sourceImage || !customPrompt.trim() || status === GenerationStatus.LOADING
